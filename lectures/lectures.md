...
- Ubuntu: Ctrl + Shift + I
***
 <div style="text-align:center"><font size=5>**Умение учиться**</font></div>
***

# <div style="text-align:center"><font size=7>Как эффективно приобретать новые знания</font></div>
...
# <div style="text-align:center"><font size=7>Инструменты обучения</font></div>
...
# <div style="text-align:center"><font size=7>4 темы обучения</font></div>
...
# <div style="text-align:center"><font size=7>Перерывы</font></div>
...
# <div style="text-align:center"><font size=7>Нейронаука и обучение</font></div>
1. Знания
...
# <div style="text-align:center"><font size=7>__I четверть «Разработчик python»__</font></div>
***
...
### <div style="text-align:center"><font size=5>***Массив***</font></div>
...
## <div style="text-align:center"><font size=6>Особенности массива</font></div>
...
### <div style="text-align:center"><font size=5>***Цикл while и ветвления if-else***</font></div>
...
## <div style="text-align:center"><font size=6>Пересборка таблиц между собой при исползовании реляционных таблиц</font></div>
...
## <div style="text-align:center"><font size=6>Нормы составления таблиц СУБД</font></div>
...
## <div style="text-align:center"><font size=6>Цикл While</font></div>
...
## <div style="text-align:center"><font size=6>Цикл for, функция range()</font></div>
...
Список - это упорядоченный конечный набор элементов. По сути список - это тот же самый массив, в котором можно хранить элементы любых типов данных.
    ...
    list_1 = []  <div style="text-align:center"><font size=5>Создание пустого списка</font></div>
...
Можно выводить словарь следующим образовм:
    ...
    for item in dictionary:
     ...
     <div style="text-align:center"><font size=5>up: ↑</font></div>
...
Функция sumNumbers(n), которая будет считать сумму всех элементов от 1 до n.
    ...
    n = int(input())  <div style="text-align:center"><font size=5>5</font></div>
...
### <div style="text-align:center"><font size=5>***Сортировка пузырьком2***</font></div>
...
### <div style="text-align:center"><font size=5>***Сортировка слиянием***</font></div>
...
## <div style="text-align:center"><font size=6>Функция enumerate</font></div>
...
## <div style="text-align:center"><font size=6>Использование языка программирования Python для автоматизации работы с веб-сервисами</font></div>
...
## <div style="text-align:center"><font size=6>Классы-обертки:</font></div>
...
## <div style="text-align:center"><font size=6>Область видимости переменных</font></div>
...
## <div style="text-align:center"><font size=6>Циклы</font></div>
...
### <div style="text-align:center"><font size=5>***График сравнения роста сложности алгоритма***</font></div>
...
## <div style="text-align:center"><font size=6>Структуры данных. Массивы. Алгоритмы массивов</font></div>
...
### <div style="text-align:center"><font size=5>***Разберем пирамидальную сортировку***</font></div>
...
## <div style="text-align:center"><font size=6>Связный список</font></div>
...
### <div style="text-align:center"><font size=5>***Основные операции со связанным списком***</font></div>
...
### <div style="text-align:center"><font size=5>***Разница связных списков и массива***</font></div>
...
### <div style="text-align:center"><font size=5>***Разворот связного списка***</font></div>

![Разворот связного списка](./images/linked_list_reversal.png)

### <div style="text-align:center"><font size=5>***Стек и очередь***</font></div>
...
## <div style="text-align:center"><font size=6>Структуры данных. Хеш-таблица. Дерево</font></div>

### <div style="text-align:center"><font size=5>***Дерево***</font></div>

Дерево - это структура данных, представленная в виде набора связанных узлов (частный случай графа).
Характеризует собой связь определенный элементов по принципу "родитель - дети".
При этом у каждой ноды может быть не более одного родителя и неограниченное количество детей.
А также не бывает цикличных связей.

![Дерево](./images/tree.png)

- Нода, которая не имеет родителей, называется корнем.
- Ноды, не имеющие детей, называются листьями.

Дерево пригодится везде, где нужно отобразить иерархическую структуру.

Варианты обхода дерева:
1. Обход в глубину
2. Обход в ширину

#### <div style="text-align:center"><font size=5>**Бинарное дерево**</font></div>

Отличается лишь тем, что количество детей у родителя максимум 2. Причем левый ребенок 
всегда меньше, чем родитель. А правый ребенок всегда больше, чем родитель.

В бинарном дереве для поиска элементов не нужно перебирать целиком все элементы. Такие деревья
используются для хранения определенных типов данных и ускорения доступа к ним (как аналог
массива для бинарного поиска, но динамически расширяемая структура).

![Сбалансированное дерево](./images/binary_tree.png)

##### <div style="text-align:center"><font size=5>*Сбалансированное дерево*</font></div>
...
То есть количество операций для обхода в глубину будет всегда примерно одинаковым.

![Сбалансированное дерево](./images/balanced_tree.png)

Често встречающийся пример сбалансированного дерева - это красно-черное дерево, где для 
соблюдения балансировки требуется выполнять дополнительные операции. Если мы добавляем в 
сбалансированное дерево элемент, мы всегда должны четко понимать, куда конкретно внутрь нашего 
дерева необходимо добавить элемент, чтобы оно сохраняло свою сбалансированность.

Поэтому для любого такого дерева характерны операции балансировки, чтобы при динамическом расширении
данного дерева оно сохраняло и свои свойства, и скорость поиска O(log n)

**Также существует АВЛ-дерево** - это сбалансированное по высоте двоичное дерево поиска: для каждой 
его вершины высота её двух поддеревьев различается не более чем на 1.

Такое дерево не считается сбалансированным:

![Не сбалансированное дерево](./images/unbalanced_tree.png)

##### <div style="text-align:center"><font size=5>*Поиск по сбалансированному дереву*</font></div>

Сбалансированное дерево дает нам идеальную структуру для бинарного поиска – корень такого дерева — это
его центральный элемент – количество элементов справа и слева от него различается не более чем на
единицу, что характерно для выбора стартовой позиции в бинарном поиске. Таким образом, сложность поиска
по сбалансированному дереву составляет O(log n), что дает очень высокую производительность.

[Поиск по сбалансированному дереву](./images/balanced_tree_finding.png)

##### <div style="text-align:center"><font size=5>*Красно-черное дерево*</font></div>

Для красно-черного дерева характерны следующие услвоия:
1. Все узлы дерева должны быть покрашены в определенный цвет (красный или черный)
2. Корень дерева всегда черный
3. Дети красного узла обязательно черные
***
Для частного случая - левостороннее красно-черное дерева, также применяется следующий критерий:
- Красный узел может быть только левым ребенком любой из нод.

При соблюдении этих условий получается красно-черное дерево.

###### <div style="text-align:center"><font size=5>Балансировка красно-черного дерева</font></div>

Для проведения балансировки существует 3 вида операций:
1. Левосторонний поворот или малый левый поворот (когда красный узел, являющий левым ребенком,
должен стать правым ребенком при этом происходит обмен значений родителя и ребенка местами).

![Левосторонний поворот красно-черного дерева](./images/left_turn_red_black_balanced_tree.png)

2. Правосторонний поворот или малый правый поворот (когда красный узел, являющий правым ребенком,
должен стать левым ребенком при этом происходит обмен значений родителя и ребенка местами).

![Правосторонний поворот красно-черного дерева](./images/right_turn_red_black_balanced_tree.png)

3. Смена цвета (когда у нас есть 2 красные новы в качестве детей, то необходимо поменять цвет.
То есть обе ноды становятся черными, а родитель становится красным)

![Смена цвета в красно-черном дереве](./images/swap_color_red_black_balanced_tree.png)

###### <div style="text-align:center"><font size=5>Критерии применения балансировочных операций</font></div>
1. Если образовалась ситуация, при которой справа образовался ребенок, нам необходимо перенести его на лево (выполняем правосторонний поворот).
2. А если левый ребенок красный и его левый ребенок тоже красный, то необходимо сделать 
левосторонний поворот
3. Если оба ребенка красные, то нужно сделать смену цвета

### <div style="text-align:center"><font size=5>***Хэш таблицы***</font></div>
...
# <div style="text-align:center"><font size=7>8. Компьютерные сети</font></div>

## <div style="text-align:center"><font size=6>Виды связей</font></div>
...
## <div style="text-align:center"><font size=6>Виды коммутации</font></div>
...
## <div style="text-align:center"><font size=6>Методы передачи данных</font></div>
...
## <div style="text-align:center"><font size=6>Устройства для передачи данных</font></div>
...
## <div style="text-align:center"><font size=6>Классификация и топология сетей</font></div>
...
## <div style="text-align:center"><font size=6>Модель OSI и TCP/IP</font></div>
...
### <div style="text-align:center"><font size=5>***1 уровень (L1). Физический.***</font></div>
...
### <div style="text-align:center"><font size=5>***2 уровень (L2). Канальный.***</font></div>
...
### <div style="text-align:center"><font size=5>***3 уровень (L3). Сетевой.***</font></div>
...
### <div style="text-align:center"><font size=5>***4 уровень (L4). Транспортный.***</font></div>
...
### <div style="text-align:center"><font size=5>***5 уровень (L5). Сеансовый.***</font></div>

Отвечает за установление и поддержание сеанса связи между приложениями

### <div style="text-align:center"><font size=5>***6 уровень (L6). Представления.***</font></div>

Описывает формат представляемых данных

### <div style="text-align:center"><font size=5>***7 уровень (L7). Приложений.***</font></div>

На прикладном уровне в итоге и объединились Сеансовый уровень и 
Уровень представления.

## <div style="text-align:center"><font size=6>TCP/IP</font></div>
...
## <div style="text-align:center"><font size=6>Инкапсуляция</font></div>
...
## <div style="text-align:center"><font size=6>Формат Ethernet фрейма</font></div>
...
## <div style="text-align:center"><font size=6>L2 уровень</font></div>
### <div style="text-align:center"><font size=5>***MTU***</font></div>
...
#### <div style="text-align:center"><font size=5>**STP протокол**</font></div>
...
### <div style="text-align:center"><font size=5>***Коммутаторы и роутеры***</font></div>
...
## <div style="text-align:center"><font size=6>L3 уровень</font></div>
### <div style="text-align:center"><font size=5>***IP адреса***</font></div>

IP адрес уникально идентифицирует какой-то один хост в L3 сети.

![Структура IP адреса](./images/ip_adress_structure.png)

### <div style="text-align:center"><font size=5>***Роутер (маршрутизатор)***</font></div>
...
### <div style="text-align:center"><font size=5>***Заголовое IP пакета, сопровождающий данные***</font></div>

![Заголовое IP пакета, сопровождающий данные](./images/ipv4_package.png)

### <div style="text-align:center"><font size=5>***Петри. Time To Live (TTL) package***</font></div>
...
### <div style="text-align:center"><font size=5>***ARP протокол (Взаимодействие L2 и L3)***</font></div>

#### <div style="text-align:center"><font size=5>**ARP-L2**</font></div>
...
#### <div style="text-align:center"><font size=5>**ARP-L3**</font></div>
...
### <div style="text-align:center"><font size=5>***Маршрутизация***</font></div>

Важный факт:

![Маршрутизация](./images/routing.png)

Как только пакет приходит на интерфейс роутера, по L2 заголовку роутер понимает, что этот пакет предназначен ему самому и отрезает его.
После чего на основе ip-destanation адреса по таблице маршрутизации решает куда отправить пакет дальше. После чего сам создает новый L2
заголовок с новыми MAC-адресами. (изменяет source MAC-адрес)

Таким образом от роутера к роутеру происходит изменение L2 заголовка, но L3 заголовок не изменяется.

#### <div style="text-align:center"><font size=5>**Соединенные сети (connected nets)**</font></div>

Когда мы настраиваем IP-адреса на интерфейсах, роутер уже понимает, что его интерфейс лежит в какой-то IP-сети, так как у него у самого есть
какой-то IP-адрес и маска-сети. Такие сети называются **Соединенные сети (connected nets)**:

![Присоединенные сети](./images/connected_nets.png)

Такие сети роутер сразу может добавить в таблицу маршрутизации. И у них будет метка "C" (у каждого маршрута есть своя буква, говорящая о происхождении маршрута)

#### <div style="text-align:center"><font size=5>**Статическая маршрутизация (static routes)**</font></div>

Еще один тип маршрутов - **Статические маршруты (static routes)**

Зачем они нужны?

У соседних сетей, связанных одним роутером, есть информация друг о друге (это соединенные сети). Но при этом, если появится еще один роутер, то роутер
уже не будет знать какая сеть находится за ним. И для указания существующих сетей вне зоны видимости роутера применяют статические маршруты ("S").

![Статическая маршрутизация](./images/static_routes.png)

Например, если из сети 1.1.1.1/24 будет отправляться пакет в сеть 3.3.3.3/24, то без указания статического маршрута в эту сеть роутер R1 не будет знать куда отправить пакет 
и уничтожет его. Тоже самое произойдет при обратной отправке пакета из 3.3.3.3/24 в сеть 1.1.1.1/24, то есть роутер R2 должен иметь в таблице маршрутизации информацию о существующей сети
1.1.1.1/24 и как в нее направить пакет.

Следовательно, чтобы связать какие-то две сети, необходимо на каждом роутере иметь статический маршрут в одну и в другую сторону (в обе сети).

Причем указание маршрута через конкретный интерфейс не является хорошей практикой, так как это может повлиять на скорость/эффективность отправки пакетов. Например:

![Плохой пример статической маршрутизации](./images/static_routes_bad_example.png)

В этом примере, если закрепить статический машрут за интерфейсом Gig0/0/0, то свичу будет наобходимо проверить за каким из роутеров находится
необходимая сеть. И только после этого будет отправлен пакет.

**Поэтому хорошей практикой является указание IP-адреса следующего роутера (next hop)** вместо указания интерфейса

Чтобы между сетями А и B была связность, на всех роутерах между этими сетями должны быть маршруты в таблице маршрутизации и в сеть А, и в сеть В.

Любые другие сети там необязательны, так как роутеры смотрят только на поле IP destination в пакете.

![Большая сеть](./images/big_static_routes.png)

В хорошей корпоративной сети все сети связаны между собой. Но использование для этого статики это не очень гибко из-за возрастающей вероятности ошибки.
Напрашивается какой-то автоматизированное решение.

#### <div style="text-align:center"><font size=5>**Динамическая маршрутизация (dynamic routes)**</font></div>

Таким решением являются динамические протоколы маршрутизации. Динамические протоколы маршрутизации делятся на два больших класса протоколов:

- **DV (Distance-vector routing protocol)**

Роутер знает только своих соседей и знает только те маршруты, которые ему сообщают соседи.
А маршрут, по которому будет отправлен пакет, выбирает на основе каких-то метрик и параметров 
выбирает лучший маршрут из предложенных соседями.

Примером является BGP протокол (Border Gateway Protocol) - это один из главных механизмов, обеспечивающих функционирование Интернета.

- **LS (Link-state routing protocol)**

Протокол отрабатывает на каждом маршрутизаторе отдельно таким образом, что на кажом из них возникает карта сети в целом. Основываясь на этой карте каждый маршрутизатор
заполняет свою таблицу маршрутизации.

Главной задачей таких протоколов является создать непротиворечивую и согласованную базу данных для карты сети (роутеры хранят карту сети в виде графа)

Среди них популярны два протокола:

1. OSPF (Open Shortest Path First) - протокол поиска кратчайшего пути (популярен в корпоративных сетях);
2. ISIS (Intermediate System to Intermediate System) - популярен в провайдерских сетях.

Преимущества:

    Мгновенно реагируют на изменения в сети

Недостатки:

    Хороши только для малых и средних корпоративных сетей, так как для больших сетей использование такого протокола будет нереальной вычислительной задачей.

##### <div style="text-align:center"><font size=5>*OSPF протокол*</font></div>

Для работы протокола OSPF достаточно включить протокол, а также необходимые хосты в сети.

Сети, полученные в результате работы протоколоа OSPF, помечаются в таблице маршрутизации буквой "О".

###### <div style="text-align:center"><font size=5>Hello пакеты</font></div>

![Приветственные пакеты OSPF](./images/OSPF_hello_packages.png)

«Hello пакет» состоит из ID устройства (уникального ID в сети, в которой работает OSPF) и списка соседей

После получения «Hello пакета» хостом-2, он запишет в «соседей» отправителя пакета (хост-1) и отправит обратно «Hello пакет»
со своим ID, а хост-1, увидев в соседях хоста-2 себя, утановит с ним OSPF-соседство (связность).

А встретившиеся на пути маршрутизаторы будут выступать в роли [broadcast-домена](#методы-передачи-данных)

###### <div style="text-align:center"><font size=5>DR и BDR (Designated Router и Backup Designated Router)</font></div>

Designated Router - это выбранный в L2-домене назначенный маршрутизатор, с которым связываются и обмениваются маршрутной информацией все остальные 
маршрутизаторы, которые уже не связываются между собой. (для оптимизации алгоритма поиска кратчайшего пути Дейкстры).

Backup Designated Router это выбранный запасной маршрутизатор в той же L2-домене.

DR и BDR следует выбирать самые мощные роутеры в L2-домене.

После выбора назначенного и запасного маршрутизаторов начинается рассылка кусочков базы данных (data base descriptions) 
для сборки карты сети, после сборки которой все роутеры переходят в состояние **full view**, из которого могут запускать алгоритм 
Дейкстры для поиска кратчайшего пути к каждой IP-сетей, о которых им известо. (алгоритм Дейксты отрабатывает с учетом стоимости пути)

###### <div style="text-align:center"><font size=5>OSPF выбор оптимального пути</font></div>

![OSPF выбор оптимального пути](./images/OSPF_path_optimisation.png)

При падении любого соединения все ссылки быстро перестраиваются и пути начинают проходить по другому пути.

###### <div style="text-align:center"><font size=5>OSPF резервирование</font></div>

![OSPF резервирование](./images/OSPF_reservation.png)

###### <div style="text-align:center"><font size=5>OSPF ECMP балансировка</font></div>

Если есть 2 пути с одинаковой скоростью, то отрабатывает ECMP (Equal Cost Multi-Path) балансировка, то есть 
происходит равномерная нагрузка двух путей.

![OSPF ECMP балансировка](./images/OSPF_ECMP_balance.png)

###### <div style="text-align:center"><font size=5>OSPF Areas</font></div>

Так как алгоритм Дейкстры чувствителен к количеству конечных узлов, OSPF может разбивать сеть на различные зоны (areas),

где area0 - BB - Back bone (каркас/скелет), а остальные зоны присоединяются к BB, благодары специальным 
маршрутизаторам - ABR - Area Border Routers 

###### <div style="text-align:center"><font size=5>OSPF. Условия связности (соседства)</font></div>

![OSPF соседство](./images/OSPF_neighbour.png)

1. Одинаковый Hello-interval (интервал рассылки «Hello пакетов»)
2. Одинаковый Dead-interval (количество «Hello пакетов», которые дозволительно потерять)
...
![OSPF Areas](./images/OSPF_areas.png)

Также есть правило:

    Чем более точен маршрут, тем больше у него приоритет. (Чем меньше единиц в маске, тем более он приоритетный)

###### <div style="text-align:center"><font size=5>OSPF. Administrative distance</font></div>

Administrative distance - это метрика, показывающая приоритет протоколов для одинаковых маршрутов.

![Параметры Administrative distance по умолчанию](./images/default_administrative_distance.png)

#### <div style="text-align:center"><font size=5>**VLAN (Virtual Local Area Network)**</font></div>

Позволяет внутри одного коммутатора, настраивать подкоммутаторы, каждый из которых будет находиться в своем L2 broadcast домене (в своем VLAN).

![VLAN на одном куммутаторе](./images/VLAN_in_one_commutator.png)

##### <div style="text-align:center"><font size=5>*VLAN тэг*</font></div>

![VLAN тэг](./images/VLAN_tag.png)

##### <div style="text-align:center"><font size=5>*Acess ports и Trunk port*</font></div>

![VLAN тэг](./images/acess_ports_and_trunk_port.png)

Как правило хосты не умеют обрабатывать VLAN-тэги, поэтому и не подозревают что они находятся в каком-то VLAN-домене,
так как всю работу добавления и отрезания VLAN-тэга за них делает коммутатор.

Trunk порты соединяют сразу два домена и в этом порту ходит трафик сразу от этих двух доменов. На этот порт обязательно должны приходить пакеты с VLAN-тэгами и
уходить тоже с VLAN-тэгами.

##### <div style="text-align:center"><font size=5>*VLAN. У каждого свой L2 домен*</font></div>

![VLAN. У каждого свой L2 домен](./images/VLAN_domen_without_router.png)

##### <div style="text-align:center"><font size=5>*VLAN на роутере*</font></div>

Ва роутере необходимо будет:

1. Либо настроить 2 интерфейса. Один для Access VLAN 10, Другой для Access VLAN 20.
2. Либо сделать в нем Trunk порт (для того чтобы он разбирал трафик) и настроить подинтерфейс из определенной IP-сети

![VLAN на роутере](./images/VLAN_with_router.png)

Это и называет изоляцией на уровне L2

# <div style="text-align:center"><font size=7>9. Гидкие методологии (Agile, SCRUM, Канбан и другие)</font></div>

## <div style="text-align:center"><font size=6>Гибкие методологии. История возникновения.</font></div>

### <div style="text-align:center"><font size=5>***Жизненный цикл IT-продукта (веб-сайт)***</font></div>
...
Чтобы создать и поддерживать IТ-продукт нужно выбрать модель и методологию разработки 
и управления (Выстроить процессы)

### <div style="text-align:center"><font size=5>***Модель и Методология разработки IT-продукта***</font></div>

Модель описывает, какие стадии жизненного цикла продукт проходит и что происходит на каждой из них

Методология - Набор методов по управлению разработкой: это правила, техники 
и принципы, которые делают её более эффективной и приводят к получению 
качественного продукта в результате

### <div style="text-align:center"><font size=5>***Модели разработки ПО***</font></div>
#### <div style="text-align:center"><font size=5>**Waterfall Model (Каскадная модель или водопад)**</font></div>
...
- Старт реализации проекта должен быть отложен до выяснения всех целей и задач 
проекта и сбора полных требований к нему
- Разработка продукта должна быть хорошо скоординированной, подчиняться разумному 
...
- Написание подробных требований к разработке
- На этапе тестирования не должно выясниться, что в них есть ошибка, 
которая влияет на весь продукт
- Сильный рост стоимости незапланированных изменений требований к 
продукту на каждом следующем этапе работ
-  Рост количества проблем в процессе проектирования с ростом проекта

Когда можно использовать каскадную модель?
1. Когда требования известны, понятны и зафиксированы
2. Нет противоречивых требований к функционалу продукта
3. Нет проблем с доступностью программистов нужной квалификации
4. В относительно небольших проектах

#### <div style="text-align:center"><font size=5>**V-образная модель**</font></div>

**Применима к системам, которым особенно важнобесперебойное функционирование**

Усовершенствованная каскадная модель.

Заказчик с командой программистоводновременно составляют требования 
к системе и описывают, как будут тестировать её на каждом этапе

![V-образная модель](./images/v_model.png)

Особенности V-образной модели:

![Особенности V-образной модели](./images/features_v_model.png)

1. Направлена на тщательную проверку и тестирование продукта, находящегося 
уже на первоначальных стадиях проектирования
2. Стадия тестирования проводится одновременно с соответствующей стадией разработки
3. Во время кодирования пишутся модульные тесты
...
Недостатки:
- Если при разработке архитектуры была допущена ошибка, то вернуться и 
исправить её будет стоить также дорого, как и в Waterfall

Когда можно использовать каскадную модель?
1. Если требуется тщательное тестирование продукта (validation & verification)
2. Для малых и средних проектов, где требования чётко определены и фиксированы
3. В условиях доступности инженеров необходимой квалификации, особенно тестировщиков

#### <div style="text-align:center"><font size=5>**Спиральная модель**</font></div>

![Спиральная модель](./images/spiral_model.png)

Продукт разрабатывается версиями. И каждый виток спирали является [каскадной моделью](#waterfall-model-каскадная-модель-или-водопад)

Как происходит разработка по спиральной модели?

![Спиральная модель](./images/development_spiral_model.png)

Особенности спиральной модели:
1. Цикл начинается с этапа сбора требований к предполагаемым изменениям, 
вносимым на данном витке, и завершается реализацией прототипа = решается 
основная проблема традиционных моделей о невозможности изменения требований 
к продукту
2. Заказчик и команда разработчиков анализируют риски проекта и 
выполняют проект итерациями
3. Последующая стадия основывается на предыдущей
4. В конце каждого витка (цикла итераций) принимается решение, продолжать ли 
проект
...
Недостатки:
- Есть риск застрять на начальном этапе (бесконечно совершенствовать первую версию продукта 
и не продвинуться к следующим)
- Разработка длится долго и стоит дорого

#### <div style="text-align:center"><font size=5>**Инкрементная модель**</font></div>
...
кодирования, внедрения и тестирования
- Предполагает выпуск на первом большом этапе продукта в базовой 
функциональности, а затем уже последовательное добавление новых функций – 
«инкрементов»
- Процесс продолжается пока не будет создана полная система

![Инкрементная модель](./images/incremental_model.png)
...
Недостатки:
- над продуктом работают несколько команд программистов – каждый 
видит продукт по своему
- разработчики будут оттягивать доработку основной функциональности 
и «пилить мелочёвку»
- подходит для проектов, в которых точное ТЗ прописано уже на старте, 
а продукт должен быстро

#### <div style="text-align:center"><font size=5>**Итеративная или итерационная модель**</font></div>

**Эта модель дает начало гибким методологиям**

- Разработка ПО как последовательность итераций
- Каждая итерация сама по себе является небольшим 
проектом в рамках общей задачи
- Каждая итерация предполагает измеримый прирост 
ценности продукта по завершении итерации
- Полные требования к ПО делятся на различные сборки
- Поэтапная сборка ПО
- Несколько циклов разработки вместе составляют жизненный цикл «мульти-водопад»
- Цикл разделён на более мелкие легко создаваемые модули
...
- Эта часть функционала становится базой для определения 
...
![Инкрементная модель vs Итеративная модель](./images/incr_model_vs_iter_model.png)

Преимущества:
- Быстрый выпуск MVP (минимальную версию продукта)
- Быстрая обратная связь от заказчика и пользователей
- Фокусировка на наиболее важных функциях ПО и улучшении их 
в соответствии с требованиями рынка и пожеланиями клиента
...
масштабировать, а вторые не выдерживают нагрузку. Возможно, придётся переписывать 
большую часть приложения.
- Отсутствие фиксированного бюджета и сроков – заказчик детально не знает, 
как выглядит конечная цель и когда закончится разработка
...
#### <div style="text-align:center"><font size=5>**Гибкие модели, методологии и подходы (Agile, Scrum, Kanban и другие)**</font></div>
##### <div style="text-align:center"><font size=5>*Agile*</font></div>

Agile стал основой гибкого подхода для разработки IT продукта
...
- Включает в себя практики, подходы и методологии, которые помогают 
создавать ИТ-продукт более эффективно

Agile включает в себя набор методологий и практических инструментов.
...
##### <div style="text-align:center"><font size=5>*Scrum*</font></div>

Фреймворк – это более сформированная методология со строгими правилами

Все роли и процессы чётко прописаны

##### <div style="text-align:center"><font size=5>*Kanban*</font></div>
...
- Каждый участник видит, какие задачи находятся 
- в работе, какие — застряли на одном из этапов, а какие уже дошли до его 
столбца и требуют внимания.

В отличие от Scrum, при использовании Kanban-подхода можно взять срочные 
задачи в разработку сразу, не дожидаясь начала следующего спринта

#### <div style="text-align:center"><font size=5>**Отличия гибких методологий от традиционных (жёстких)**</font></div>
...
- Опытный руководитель проекта / разработки должен найти подходящую методологию 
или совместить несколько

Поэтому постепенно произошел переход от традиционных моделей к гибким методологиям:

![Схема моделей](./images/models_scheme.png)
